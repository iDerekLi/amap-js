...
var _Loader = _interopRequireDefault(__webpack_require__(84));

exports.Loader = _Loader.default;

var _load = _interopRequireDefault(__webpack_require__(85));

exports.load = _load.default;

var _AMapJSAPILoader = _interopRequireDefault(__webpack_require__(86));

exports.AMapJSAPILoader = _AMapJSAPILoader.default;

var _AMapUILoader = _interopRequireDefault(__webpack_require__(88));
...
var AMapJS = {
  ...
  load: _load.default,
  AMapJSAPILoader: _AMapJSAPILoader.default,
  AMapUILoader: _AMapUILoader.default
};
var _default = AMapJS; // eslint-disable-line no-undef
...
function load(loaders, callbackThen, callbackCatch, callbackFinally) {
  ...
  var _loaders = Array.isArray(loaders) ? loaders : [loaders];
  ...
  var allPromise = Promise.all(resourcesPromise);
  var callback = {
    then: callbackThen,
    catch: callbackCatch,
  ...
  var callbackQ = {
    then: function then(res) {
      callback.then.apply(callback, res);
    },
    catch: function _catch(firstError) {
...
var _Loader2 = _interopRequireDefault(__webpack_require__(84));

var _queryParams = _interopRequireDefault(__webpack_require__(87));
...
var RANDOM = Math.ceil(Math.random() * Math.pow(10, 16)); // 默认参数

var DEFAULT_JSAPI_CONFIG = {
  protocol: "https:",
  // 脚本加载协议
...
/*#__PURE__*/
function (_Loader) {
  _inheritsLoose(AMapJSAPILoader, _Loader);

  function AMapJSAPILoader(config) {
    var _this;

    _this = _Loader.call(this, config) || this;

    var _config = Object.assign({}, DEFAULT_JSAPI_CONFIG, config);

    _this.protocol = _config.protocol;
    _this.path = _config.path;
    _this.params = _extends({
      key: _config.key,
      v: _config.v,
      callback: _config.callback
    }, _config.params);
    _this.crossOrigin = _config.crossOrigin;
    _this.keepScriptTag = _config.keepScriptTag;
    return _this;
  }
  /**
   * 加载资源
  ...
  var _proto = AMapJSAPILoader.prototype;
  ...
  _proto.load = function load() {
    ...
    var callbackName = this.params.callback;
    return new Promise(function (resolve, reject) {
      ...
      if (typeof jsapi.onload !== "undefined") {
        jsapi.onload = function () {
          if (!_this2.keepScriptTag) _this2.removeScriptTag(jsapi);
        };
      } else {
  ...
  _proto.checkCorrectness = function checkCorrectness() {
    if (!window.AMap) return false;
    var checkAPI = ["v", "Pixel", "LngLat", "Size", "Bounds", "Map"];

    for (var _i = 0; _i < checkAPI.length; _i++) {
      var key = checkAPI[_i];
  ...
  _proto.versionCompare = function versionCompare(left, right) {
    return left === right;
  }
  /**
   * 删除脚本标签
  ...
  _proto.removeScriptTag = function removeScriptTag(el) {
    el.parentNode.removeChild(el);
  };

  _proto.toRequestURL = function toRequestURL() {
    var protocol = this.protocol;
    var path = this.path;
    var params = (0, _queryParams.default)(this.params);
    var location = protocol + "//" + path + "?" + params;
    return location;
  }
  /**
   * 获取请求地址
...
function (_Loader) {
  ...
  function AMapUILoader(config) {
    var _this;

    _this = _Loader.call(this, config) || this;

    var _config = Object.assign({}, DEFAULT_UI_CONFIG, config);

    _this.v = _config.v;
    _this.protocol = _config.protocol;
    _this.path = _config.path;
    _this.crossOrigin = _config.crossOrigin;
    _this.AMapUIProtocol = _config.AMapUIProtocol;
    _this.initAMapUI = _config.initAMapUI;
    _this.isAutoInitAMapUI = _config.isAutoInitAMapUI;
    _this.keepScriptTag = _config.keepScriptTag; // 设置强制加载协议

    if (typeof _this.AMapUIProtocol === "string") {
      _this.setAMapUIProtocol(_this.AMapUIProtocol);
    }
    ...
    return new Promise(function (resolve, reject) {
      if (typeof uiScript.onload !== "undefined") {
        uiScript.onload = function () {
          if (!_this2.keepScriptTag) _this2.removeScriptTag(uiScript);

          var callback = function callback() {
            return window[_this2.initAMapUI]() || window.AMapUI;
          };

          resolve(_this2.isAutoInitAMapUI ? callback() : callback);
        };
      } else {
        uiScript.onreadystatechange = function () {
          if (uiScript.readyState == "loaded" || uiScript.readyState == "complete") {
            ...
            resolve(_this2.isAutoInitAMapUI ? _callback() : _callback);
          }
        };
      }
  ...
  _proto.checkCorrectness = function checkCorrectness() {
    ...
    var checkAPI = ["libConf", "uiMods", "docProtocol", "version"];
  ...
  _proto.toRequestURL = function toRequestURL() {
    var protocol = this.protocol;
    var v = this.v;
    var path = this.path.replace("{v}", v);
    var location = protocol + "//" + path;
    return location;
  }
  /**
   * 获取请求地址
  ...
  _proto.setAMapUIProtocol = function setAMapUIProtocol(AMapUIProtocol) {
    var protocol = "https:" === AMapUIProtocol ? "https:" : "http:";
