...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function (test, buggy, set) {
      try {
        set = __webpack_require__(17)(Function.call, __webpack_require__(58).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
...
__webpack_require__.d(__webpack_exports__, "load", function() { return /* reexport */ es_load; });
__webpack_require__.d(__webpack_exports__, "AMapLoader", function() { return /* reexport */ amap_jsapi_loader; });
__webpack_require__.d(__webpack_exports__, "AMapUILoader", function() { return /* reexport */ amap_ui_loader; });
...
// CONCATENATED MODULE: ./es/loaders/loader.js
...
var loader_Loader = /*#__PURE__*/function () {
  ...
  _proto.load = function load() {
    return promise_default.a.resolve(this);
  };
...
// CONCATENATED MODULE: ./es/load.js
...
function load_load(loaders) {
  ...
  loaders.forEach(function (loader) {
    if (loader instanceof loaders_loader) {
      promiseList.push(loader.load());
    } else {
      promiseList.push(loader);
    }
  });
  return promise_default.a.all(promiseList);
}

/* harmony default export */ var es_load = (load_load);
// EXTERNAL MODULE: ./node_modules/@babel/runtime-corejs2/core-js/reflect/construct.js
var construct = __webpack_require__(8);
var construct_default = /*#__PURE__*/__webpack_require__.n(construct);

// EXTERNAL MODULE: ./node_modules/@babel/runtime-corejs2/core-js/object/assign.js
var object_assign = __webpack_require__(59);
...
var iterator = __webpack_require__(60);
...
var get_prototype_of = __webpack_require__(39);
var get_prototype_of_default = /*#__PURE__*/__webpack_require__.n(get_prototype_of);

// EXTERNAL MODULE: ./node_modules/@babel/runtime-corejs2/core-js/object/set-prototype-of.js
var set_prototype_of = __webpack_require__(61);
...
// CONCATENATED MODULE: ./es/loaders/script-loader.js
...
var _promise = symbol_default()('promise');

var script_loader_ScriptLoader = /*#__PURE__*/function () {
  ...
  _proto.load = function load() {
    ...
    this[_promise] = new promise_default.a(function (resolve, reject) {
...
/* harmony default export */ var script_loader = (script_loader_ScriptLoader);
// CONCATENATED MODULE: ./es/loaders/amap-jsapi-loader.js
...
var amap_jsapi_loader_promise = symbol_default()('promise');

var count = 0;

var amap_jsapi_loader_AMapLoader = /*#__PURE__*/function (_Loader) {
  ...
  function AMapLoader(options) {
    ...
    _this.AMap = null;
    _this[amap_jsapi_loader_promise] = null;
    return _this;
  }
  ...
  _proto.load = function load() {
    ...
    if (this[amap_jsapi_loader_promise]) return this[amap_jsapi_loader_promise];
    this.status = amap_jsapi_loader_STATUS.loading;
    this[amap_jsapi_loader_promise] = new promise_default.a(function (resolve, reject) {
      var callbackName = '__onAMapLoaded' + count++;
      var script = new script_loader("https://webapi.amap.com/maps?key=" + _this2.key + "&v=" + _this2.version + "&plugin=" + _this2.plugins.join(',') + "&callback=" + callbackName);

      window[callbackName] = function () {
        delete window[callbackName];
        _this2.AMap = window.AMap;
        _this2.status = amap_jsapi_loader_STATUS.loaded;
        resolve(_this2);
      };

      script.load().catch(function (e) {
        delete window[callbackName];
        _this2[amap_jsapi_loader_promise] = null;
        _this2.status = amap_jsapi_loader_STATUS.failed;
        reject(e);
      });
    });
    return this[amap_jsapi_loader_promise];
  };
...
/* harmony default export */ var amap_jsapi_loader = (amap_jsapi_loader_AMapLoader);
// CONCATENATED MODULE: ./es/loaders/amap-ui-loader.js
...
function amap_ui_loader_createSuper(Derived) {
  return function () {
    var Super = getPrototypeOf_getPrototypeOf(Derived),
        result;

    if (amap_ui_loader_isNativeReflectConstruct()) {
      var NewTarget = getPrototypeOf_getPrototypeOf(this).constructor;
...
function amap_ui_loader_isNativeReflectConstruct() {
  if (typeof Reflect === "undefined" || !construct_default.a) return false;
  if (construct_default.a.sham) return false;
  if (typeof Proxy === "function") return true;
...
var amap_ui_loader_STATUS = {
  created: 'created',
  loading: 'loading',
  loaded: 'loaded',
  failed: 'failed'
};
var amap_ui_loader_DefaultOptions = {
  version: '1.0'
};

var amap_ui_loader_promise = symbol_default()('promise');

function noop() {}

var amap_ui_loader_AMapUILoader = /*#__PURE__*/function (_Loader) {
  _inheritsLoose(AMapUILoader, _Loader);

  var _super = amap_ui_loader_createSuper(AMapUILoader);
  ...
  function AMapUILoader(options) {
    ...
    var _DefaultOptions$optio = _extends({}, amap_ui_loader_DefaultOptions, {}, options),
        version = _DefaultOptions$optio.version;

    _this.version = version;
    _this.initAMapUI = noop;
    _this.AMapUI = null;
    _this[amap_ui_loader_promise] = null;
    return _this;
  }
  ...
  _proto.load = function load() {
    ...
    if (this[amap_ui_loader_promise]) return this[amap_ui_loader_promise];
    this.status = amap_ui_loader_STATUS.loading;
    this[amap_ui_loader_promise] = new promise_default.a(function (resolve, reject) {
      var script = new script_loader("https://webapi.amap.com/ui/" + _this2.version + "/main-async.js");
      script.load().then(function () {
        ...
        _this2.status = amap_ui_loader_STATUS.loaded;
        resolve(_this2);
      }).catch(function (e) {
        _this2[amap_ui_loader_promise] = null;
        _this2.status = amap_ui_loader_STATUS.failed;
        reject(e);
      });
    });
    return this[amap_ui_loader_promise];
  };
...
/* harmony default export */ var amap_ui_loader = (amap_ui_loader_AMapUILoader);
...
var AMapJS = {
  ...
  load: es_load,
  AMapLoader: amap_jsapi_loader,
  AMapUILoader: amap_ui_loader
};
/**
 * Export
 */
...
/* harmony default export */ var es = __webpack_exports__["default"] = (AMapJS);
